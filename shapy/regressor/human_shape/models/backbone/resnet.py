...
from torchvision.models.resnet import ResNet, Bottleneck, BasicBlock, ResNet18_Weights, ResNet34_Weights, ResNet50_Weights, ResNet101_Weights, ResNet152_Weights
...
def resnet18(pretrained=False, **kwargs):
    ...
    if pretrained:
        ...
        model.load_state_dict(model_zoo.load_url(ResNet18_Weights.IMAGENET1K_V2.url),
                              strict=False)
    return model
